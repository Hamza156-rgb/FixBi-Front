...
@Component({
  selector: 'app-change-password-provider',
  templateUrl: './change-password-provider.component.html',
  styleUrls: ['./change-password-provider.component.scss']
})
export class ChangePasswordProviderComponent implements OnInit {
